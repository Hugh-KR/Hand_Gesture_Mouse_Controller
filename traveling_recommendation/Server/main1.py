...
def index():
    ...
    if request.method == 'POST':
        ...
        recommend = list(value.get('x'))
        intRecommend = list(map(int,recommend))
        print(intRecommend[:18])
        print(intRecommend[18:19])
    ...
    for place in recommend_place:
        image_list.append('../resources/img/place/' + place + '.jpg')

    total_list.append(recommend_place)
    total_list.append(image_list)
    return {'place' : total_list}
